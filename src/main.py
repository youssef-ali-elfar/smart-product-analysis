...
def main():
    ...
    while True:
        ...
        if not all_found:
            ...
            cols_join = natural_join(missing_cols)
            tip_text = f"Detected {BOLD}{missing_values_count} missing values{RESET} in {cols_join} in your dataset. Proceed to {BOLD}Stage 2: Data Cleaning{RESET} to handle them!"
        elif not is_virtual:
