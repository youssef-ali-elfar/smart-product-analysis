...
def main():
    ...
    epilog_text = (
        "Examples:\n"
        "  python src/main.py            # Display system status & analysis roadmap\n"
        "  python src/main.py --init     # Initialize data/ directory with sample dataset\n"
        "  python src/main.py --plain    # Run in plain-text mode (screen reader friendly)\n"
        "  python src/main.py --no-color # Disable ANSI colors while retaining emojis"
    )
