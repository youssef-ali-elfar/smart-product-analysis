...
def main():
    ...
    epilog_text = (
        ...
        "  python src/main.py --init     Initialize sample workspace data\n"
        "  python src/main.py --plain    Run in plain-text accessibility mode\n"
        "  python src/main.py --no-color Disable ANSI colors in output"
    )
