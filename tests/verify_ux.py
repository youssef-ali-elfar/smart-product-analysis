        ...
        for scenario in scenarios:
            ...
            try:
                ...
                if scenario['name'] == "Dataset with Missing Values":
                    ...
                    self.assertIn("Detected 4 missing values in your dataset. Proceed to Stage 2: Data Cleaning to handle them! (Missing in name, category, price, and stock)", stripped_output)
