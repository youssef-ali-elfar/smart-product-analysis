...
class TestBasic(unittest.TestCase):
    ...
    def test_missing_values_detection_and_tip(self, mock_open, mock_getsize, mock_isfile, mock_listdir, mock_isdir, mock_get_lib_version):
        ...
        self.assertIn("Detected 4 missing values in your dataset. Proceed to Stage 2: Data Cleaning to handle them! (Missing in name, category, price, and stock)", output)
